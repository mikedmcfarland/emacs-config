...
** Buffer display
I like having certain buffers open in a new frame, like help
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  ;;          (result (org-babel-js-execute-node full-body)))
  ;;     (org-babel-result-cond (cdr (assoc :result-params params))
  ;;       result (org-babel-js-read result))))

  ;; ;; (defun org-babel-js-execute-node (script)
  ;; ;;   (shell-command-to-string (org-babel-js-cmd-format script)))

  ;; (defun org-babel-js-cmd-format(script)
  ;;   (format "%s -e \"%s\"" org-babel-js-cmd (shell-quote-argument script)))


  ;; (defvar org-babel-js-transpile-cmd "babel")

  ;; (defun org-babel-js-execute-node(full-body)
  ...
  ;; (defun js-transpile-buffer
  ;;     (shell-command-on-region (point-min) (point-max) "babel" t t))
...
A bunch of keybindings that really should be put into appropriate sections.
  #+begin_src emacs-lisp
    ...
    (map-n-v-evil-states (kbd "SPC f") 'projectile-find-file)
    (map-n-v-evil-states (kbd "SPC p") 'projectile-switch-project)
    (map-n-v-evil-states (kbd "SPC b") 'helm-mini)
    (map-n-v-evil-states (kbd "SPC x") 'helm-M-x)
