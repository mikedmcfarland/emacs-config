...
* Key Bindings
  ...
  #+begin_src emacs-lisp
    ...
    (defun map-normal-visual-evil-states (keys action)
      (define-key evil-normal-state-map keys action)
      (define-key evil-visual-state-map keys action))

    (global-set-key (kbd "C-c C-t")   'js-jump-to-implementation-or-test)
    ...
    ;; (define-key mc/keymap (kbd "C-p") 'mc/mark-previous-like-this)
    (define-key mc/keymap (kbd "C-p") 'mc/unmark-next-like-this)
    (define-key mc/keymap (kbd "C-S-p") 'mc/unmark-previous-like-this)
    (define-key mc/keymap (kbd "M-m") 'mc/mark-more-like-this-extended)
    ...
    (map-normal-visual-evil-states (kbd "SPC SPC") 'evil-ace-jump-word-mode)
    (map-normal-visual-evil-states (kbd "SPC r") 'js2r-rename-var)
    (map-normal-visual-evil-states (kbd "SPC l") 'js2r-log-this)
    (map-normal-visual-evil-states (kbd "SPC c") 'evilnc-comment-or-uncomment-lines)

    (global-set-key (kbd "C-s") 'save-buffer)
    (map-normal-visual-evil-states (kbd "SPC s") 'save-buffer)
    ...
    ;; (defun set-keys-for-org-src
    ;;     (map-normal-visual-evil-states (kbd "SPC '") 'org-edit-src-exit))
    ;; (defun set-keys-for-org
    ;;     (map-normal-visual-evil-states (kbd "SPC '") 'org-edit-special))
  #+end_src
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'load-path "~/.emacs.d/vendor/Emacs-wgrep")
  (require 'wgrep)
  (require 'wgrep-helm)
  (require 'wgrep-ack)
#+end_src
...
- Do it with evil searches http://vim.wikia.com/wiki/Search_for_visually_selected_text
